    ...
    def __init__(
        ...
        **kwargs,
        ...
        if os.path.exists(pjoin(data_root, f'tmp/{split}{subset}_data.pkl')):
            ...
            if tmpFile:
                os.makedirs(pjoin('/kaggle/working/MotionGPT/temp', 'tmp'), exist_ok=True)
                with open(pjoin('/kaggle/working/MotionGPT/temp', f'tmp/{split}{subset}_data.pkl'),
                          'wb') as file:
                    pickle.dump(data_dict, file)
                with open(pjoin('/kaggle/working/MotionGPT/temp', f'tmp/{split}{subset}_index.pkl'),
                          'wb') as file:
